...
```html
<button class="bg-[--color-tahiti] text-white hover:bg-[--color-bermuda]">
  Custom Color Button
</button>
```
  ...
  <div class="container mx-auto px-4 py-8">
    <div class="card animate-fade-in">
      ...
      <p class="text-gray-600 mb-6">
        This is a card component with Tailwind CSS v4.
      </p>
...
@layer components {
  ...
  .btn-outline { @apply border-2 border-blue-600 text-blue-600 hover:bg-blue-50; }
}
```
