---
description: '⚠️ DEPRECATED: This instruction file has been migrated to Agent Skills. See .github/skills/css-standards/'
applyTo: '**/*.{css,sass,scss,js,jsx,ts,tsx,svelte}'
deprecated: true
migrated-to: '.github/skills/css-standards/SKILL.md'
---
...
**New location**: [.github/skills/css-standards/SKILL.md](../skills/css-standards/SKILL.md)

Please refer to the new skill for all CSS standards.
