---
description: '⚠️ DEPRECATED: This instruction file has been migrated to Agent Skills. See .github/skills/nuxt-development/'
applyTo: '**/*.vue'
deprecated: true
migrated-to: '.github/skills/nuxt-development/SKILL.md'
---
...
**New location**: [.github/skills/nuxt-development/SKILL.md](../skills/nuxt-development/SKILL.md)

Please refer to the new skill for all Nuxt.js development standards.
