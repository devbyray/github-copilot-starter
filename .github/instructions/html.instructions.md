---
description: '⚠️ DEPRECATED: This instruction file has been migrated to Agent Skills. See .github/skills/html-standards/'
applyTo: '**/*.{html,vue,twig,php,cshtml,svelte}'
deprecated: true
migrated-to: '.github/skills/html-standards/SKILL.md'
---
...
**New location**: [.github/skills/html-standards/SKILL.md](../skills/html-standards/SKILL.md)

Please refer to the new skill for all HTML standards.
